CASE WHEN offers.university_id IN ({average_offered_full_fixed_semi}) THEN
...
ELSE
  ...
  ELSE
    CASE WHEN offers.university_id IN ({fixed_198_semi}) THEN 198.0
    ELSE
                  ...
                  ELSE
                      ...
                      ELSE 
                        ...
                        THEN 
                          ...
                          END
                        ELSE 
                          CASE WHEN ({k} * (({real_discount}) * 1 + 1.3) * ({offered_balcao})) < {min}
                          THEN {min}
