...
from (
    select
        ...
        round(pre_enrollment_fees.value+0.01,2),'|',
        round(pre_enrollment_fees.value+0.02,2),'|',
        round(pre_enrollment_fees.value+0.03,2),'|',
        round(pre_enrollment_fees.value*1.1,2)) pre_enrollment_fees,
