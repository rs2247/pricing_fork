...
from (
    select
        ...
        case when offers.discount_percentage=40. then round(0.75*university_offers.full_price+0.01,2)
            when offers.discount_percentage=45. then round(0.85*university_offers.full_price+0.01,2)
            when offers.discount_percentage=50. then round(0.95*university_offers.full_price+0.01,2) end,'|',
        case when offers.discount_percentage=40. then round(0.75*university_offers.full_price+0.02,2)
            when offers.discount_percentage=45. then round(0.85*university_offers.full_price+0.02,2)
            when offers.discount_percentage=50. then round(0.95*university_offers.full_price+0.02,2) end,'|',
        case when offers.discount_percentage=40. then round(0.75*university_offers.full_price+0.03,2)
            when offers.discount_percentage=45. then round(0.85*university_offers.full_price+0.03,2)
            when offers.discount_percentage=50. then round(0.95*university_offers.full_price+0.03,2) end) pre_enrollment_fees,
